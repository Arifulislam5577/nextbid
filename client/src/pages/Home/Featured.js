      ...
      <div className="flex gap-5 items-center">
        ...
        <div className="lg:w-1/2 w-full p-10 bg-gray-200">
          ...
          <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5 gap-5">
            ...
            <h1 className="text-xl font-bold text-orange-600">$200</h1>
          </div>
          <div className="flex">
            <span className="title-font font-bold text-2xl text-gray-900">
              $588.00
            </span>
            <button className="flex ml-auto text-white bg-orange-600 border-0 py-2.5 px-6 focus:outline-none  rounded">
              Bid Now
            </button>
