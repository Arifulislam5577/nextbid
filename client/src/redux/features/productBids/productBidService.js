...
export const createNewProductBid = createAsyncThunk(
  ...
  async (bidInfo, thunkAPI) => {
    let api = `${process.env.REACT_APP_SERVER_API}/api/v1/bid`;
...
export const getProductBid = createAsyncThunk(
  ...
  async (productId, thunkAPI) => {
    let api = `${process.env.REACT_APP_SERVER_API}/api/v1/bid?productInfo=${productId}`;
...
export const getUserBid = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    ...
    let api = `${process.env.REACT_APP_SERVER_API}/api/v1/bid/${userId}`;
